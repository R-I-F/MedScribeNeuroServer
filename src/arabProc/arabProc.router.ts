...
export class ArabProcRouter{
    ...
    constructor(@inject(ArabProcController) private arabProcController: ArabProcController){
    ...
    private initRoutes(){
        this.router.get(
            ...
            async (req: Request, res: Response)=>{
                try{
                    const allArabProcs = await this.arabProcController.handleGetAllArabProcs(req, res);
        ...
        this.router.post(
            ...
            async (req: Request, res: Response)=>{
                ...
                if(result.isEmpty()){
                    try{
                        const newArabProc = await this.arabProcController.handlePostArabProc(req, res)
        ...
        this.router.post(
            ...
            async(req: Request, res: Response)=>{
                ...
                if(result.isEmpty()){
                    try{
                        const resp = await this.arabProcController.handlePostArabProcFromExternal(req, res)
