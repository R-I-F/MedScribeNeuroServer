...
/**
 * Production KA DB - for running INDEX-ONLY migrations (SQL_*_DEFAULT + SQL_DB_DEF_NAME_KA).
 * Only the four "Add*Index" migrations are registered. No table creation, no data changes.
 */
function getProductionIndexMigrationsConfig(): DataSourceOptions {
...
export const ProductionIndexMigrationsDataSource = new DataSource(
  getProductionIndexMigrationsConfig()
);
